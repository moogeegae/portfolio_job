...
<html>
                    	...
                    	<div>추천 도서 작성</div>
                			<form id="forminsert" enctype="multipart/form-data" method="post">
	                			<table>
									...
									<tr>
										<td>추천하는 이유</td>
										<td><textarea name="contents" cols="40" rows="15" required="required"></textarea></td>
									</tr>
	                			</table>
	                			<section id="commandCell">
									<input type="button" onclick="wgo()" value="추천글 등록">&nbsp;&nbsp;
    ...
    <script>
    	...
    	function write(){
    		$('#formselect').attr('action','MyRecommendWrite.somoa').submit();
    	};
