    ...
    <body>
        <div id="wrap">
            ...
            <div class="main_site">
                ...
                <section id="service">
                	<%
                		List<Qna> list = (List<Qna>) request.getAttribute("articleList");
                	...
                	<article>
                		...
                		<div id="qna">
                			<div id="titleandinsert">
	                			...
	                			<a href="QnaInsert.jsp"><button>문의하기</button></a>
                			</div>
                			<table>
                				<tr>
                					<td>글번호</td>
                			...
                			<%
                				...
                				for(int i=0;i<list.size();i++){
                					if(true){	//result와 qna_re_ref가 같은걸 다 찾아라
                			...
                			%>
                				<tr>
                					...
                					<td>
	                					<%
	                						if(list.get(i).getQna_re_lev()!=0){
	                							for(int a=0;a<=list.get(i).getQna_re_lev()+1;a++){
	                					%>
	                								&nbsp;
										<%
	                							}
	                					...
	                					%>
                						<a href="login11qnaDetail.somoa?qna_num=<%=list.get(i).getQna_num() %>&page=<%=nowPage %>"><%=list.get(i).getQna_title() %></a>
                					</td>
                					<td><%=list.get(i).getQna_id() %></td>
                					<td><%=list.get(i).getQna_complete() %></td>
                		...
                		<div id="pageList">
							...
							[이전]&nbsp;
							<%}else{ %>
							<a href="login11qna.somoa?page=<%=nowPage-1 %>&result=<%=result%>">[이전]</a>&nbsp;
							<%} %>
							...
							[<%=a %>]
							<%}else{ %>
							<a href="login11qna.somoa?page=<%=a %>&result=<%=result%>">[<%=a %>]
							</a>&nbsp;
							<%} %>
							<%} %>
							...
							[다음]
							<%}else{ %>
							<a href="login11qna.somoa?page=<%=nowPage+1 %>&result=<%=result%>">[다음]</a>
							<%} %>
                		</div>
                		</div>
                	</article>
