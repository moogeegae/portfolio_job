...
<html>
            ...
            <div class="main_site">
                ...
                <section id="service">
                	...
                	<article>
                		...
                		<div id="qna" class="replyqna">
                			<%
                				Qna list = (Qna) request.getAttribute("qna");
                			...
                			<input type="hidden" name="qna_num" value="<%=list.getQna_num() %>">
							<input type="hidden" name="qna_re_ref" value="<%=list.getQna_re_ref() %>">
							<input type="hidden" name="qna_re_lev" value="<%=list.getQna_re_lev() %>">
							<input type="hidden" name="qna_re_seq" value="<%=list.getQna_re_seq() %>">
							<input type="hidden" name="qna_title" value="<%=list.getQna_id() %>님의 문의에 대한 답변입니다." />
	                			<table>
	                				<tr>
	                					<td colspan="3"><%=list.getQna_id() %>님의 문의에 대한 답변입니다.</td>
	                				</tr>
	                				<tr>
	                					<td>아이디</td>
										<td><input type="text" name="qna_id" class="replyinput"/></td>
										<td>
											<select name="qna_complete">
												<option>답변완료</option>
												<option>답변대기</option>
											</select>
										</td>
									...
									<tr>
										<td>비밀번호</td>
										<td><input type="password" name="qna_pass" class="replyinput"/></td>
										<td></td>
									</tr>
									<tr>
										<td>답 변 내 용</td>
										<td colspan="2"><textarea name="qna_content" cols="40" rows="15"></textarea></td>
									</tr>
	                			</table>
	                			<section id="pageList">
									<input type="button" onclick="reply()" value="답변글 등록">&nbsp;&nbsp;
    ...
    /*form reply*/
    	function reply(){
    		$('#formreply').attr('action','qnaReplyForm.somoa').submit();
    	};
