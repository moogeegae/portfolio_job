    ...
    <body>
        <div id="wrap">
            ...
            <div class="main_site">
                ...
                <section id="service">
                	<%
                		List<Faq> list = (List<Faq>) request.getAttribute("articleList");
                	...
                	<article>
                		<div id="qna">
                			<div id="titleandinsert">
    	            			<div id="qnatitle">FAQ</div>
                			</div>
                			<div id="faqsub">고객님들께서 궁금해 하시는 내역을 정리하였습니다.<br><br><br></div>
                				<div id="faqbofir">
                					<div class="faqboardA"><img src="../somoaimage/question.PNG" /></div>
                					<div class="faqboardB">FAQ카테고리</div>
                					<div class="faqboardC">문의내용</div>
                				</div>
                				<%	
                					if(list.size()==0){
                				%>
                				<div id="nofaq">등록된 항목이 없습니다.(DB를 입력해주세요.)</div>
                				<%
                					}else{
                						for(int i=0;i<list.size();i++){
                				%>		
                				<div class="faqbo" onclick="faqopen()">
                					<div class="faqboardA"><img src="../somoaimage/question.PNG" /></div>
                					<div class="faqboardB">[<%=list.get(i).getFaq_category() %>]</div>
                					<div class="faqboardC"><%=list.get(i).getFaq_title() %></div>
                				</div>
                				<div class="faqbo faqcl" style="display:none;"><%=list.get(i).getFaq_content() %></div>
                				<%		
                						}
                					}
                				%>
	                	<div id="pageList">
							...
							[이전]&nbsp;
							<%}else{ %>
							<a href="notice.somoa?page=<%=nowPage-1 %>">[이전]</a>&nbsp;
							<%} %>
							...
							[다음]
							<%}else{ %>
							<a href="notice.somoa?page=<%=nowPage+1 %>">[다음]</a>
							<%} %>
                		</div>
	                	</div>
                	</article>
