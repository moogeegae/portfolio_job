...
<html>
            ...
            <div class="main_site">
                ...
                <section id="service">
                	...
                	<article>
                		...
                		<!-- 들어갈게 id, pass, title, content, file -->
                		<div id="qna" class="qnainsert">
                			<div id="qnatitle">문의글 작성</div>
                			<form id="forminsert" enctype="multipart/form-data" method="post">
	                			<table>
	                				<tr>
	                					<td>제목</td>
	                					<td><input type="text" name="qna_title" id="inserttitle" required="required"/></td>
	                				</tr>
	                				<tr>
	                					<td>아이디</td>
										<td><input type="text" name="qna_id" class="qnapeople" value="<%=result %>"/></td>
									</tr>
									<tr>
										<td>비밀번호</td>
										<td><input type="password" name="qna_pass" class="qnapeople" required="required"/></td>
									</tr>
									<tr>
										<td>문 의 내 용</td>
										<td><textarea name="qna_content" cols="60" rows="15" required="required"></textarea></td>
									</tr>
									<tr>
										<td>파일 첨부</td>
										<td><input name="qna_file" type="file" required="required" /></td>
									</tr>
	                			</table>
	                			<section id="pageList">
									<input type="button" onclick="insert()" value="문의글 등록">&nbsp;&nbsp;
    ...
    /*form reply*/
    	function insert(){
    		$('#forminsert').attr('action','QnaInsert.somoa').submit();
    	};
