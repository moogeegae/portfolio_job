            ...
            <div class="main_site">
                ...
                <section id="printoutBookGenre" >
                	<article style="display: flex;justify-content: center;">
                		<div><i class="fas fa-atlas"></i>&nbsp;&nbsp;&nbsp;ebook</div>
                		<table>
	    	            	<tr>
	        	        		<td><a href="ebookboard.somoa?genre=A">소설</a></td>
	            	            <td><a href="ebookboard.somoa?genre=B">시,에세이</a></td>
	                	        <td><a href="ebookboard.somoa?genre=C">자기계발</a></td>
	                    	    <td><a href="ebookboard.somoa?genre=D">어린이</a></td>
	                        	<td><a href="ebookboard.somoa?genre=E">과학</a></td>
		                	</tr>
	                    	<tr>
	                    	    <td><a href="ebookboard.somoa?genre=F">수험서</a></td>
	                	        <td><a href="ebookboard.somoa?genre=G">전공교재</a></td>
	            	            <td><a href="ebookboard.somoa?genre=H">잡지</a></td>
	        	                <td><a href="ebookboard.somoa?genre=I">사전</a></td>
	    	                    <td><a href="ebookboard.somoa?genre=korean">전체보기</a></td>
		                    </tr>
                		</table>
                	</article>
                	<article>
                ...
                <section id="bookboard" style="display:flex;flex-direction: row;flex-wrap:wrap;"><!-- 게시판 -->
                	<%
                    ...
                    <%
                   	...
                   	%> 		
                    <article class="bookall">
                    	<div><a href="booknotice.somoa?code=<%=code%>&page=<%=nowPage %>&ebook=yes"><img src="../somoaimage/book/<%=cover %>" /></a></div>
                    	<div><a href="booknotice.somoa?code=<%=code%>&page=<%=nowPage %>&ebook=yes"><%=title %></a></div>
                    	<div class="bookinfo">
                    		<span><%=author %></span>
                    		<span>|</span>
                    		<span><%=publisher %></span>
               	...
               	<section id="pageList">
					...
					[이전]&nbsp;
					<%}else{ %>
					<a href="ebookboard.somoa?page=<%=nowPage-1 %>&genre=<%=bookgenre%>">[이전]</a>&nbsp;
					<%} %>
					...
					[<%=a %>]
					<%}else{ %>
					<a href="ebookboard.somoa?page=<%=a %>&genre=<%=bookgenre%>">[<%=a %>]
					</a>
					<%} %>
					<%} %>
					...
					&nbsp;[다음]
					<%}else{ %>
					<a href="ebookboard.somoa?page=<%=nowPage+1 %>&genre=<%=bookgenre%>">&nbsp;[다음]</a>
					<%} %>
                </section>
