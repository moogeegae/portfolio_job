                	...
                	<article>
                		<div id="qna">
                			<div id="titleandinsert">
    	            			<div id="qnatitle">공지사항</div>
                			</div>
                			<div id="faqsub">고객님들께 안내해드리는 내역을 정리하였습니다.<br><br><br></div>
                				<div class="faqbo" id="faqbofir">
                					<div class="faqboardA"><img src="../somoaimage/notice.PNG" /></div>
                					<div class="faqboardB">공지카테고리</div>
